        ...
        <div class="w-full">
            ...
            <div class="relative" 
                ...
                <input 
                    ...
                    id="searchInput" 
                    @keydown.slash.window="$event.preventDefault(); $refs.searchInput.focus()"
                    x-ref="searchInput"
                ...
                <div 
                    class="absolute mt-2 w-full overflow-hidden" 
                    x-show="searchFocused && $wire.showResults"
                    x-cloak>
                                        ...
                                        <div class="flex gap-x-4">
                                            @if($result->company?->logo)
                                                <img class="h-12 w-12 flex-none rounded-full bg-gray-50" 
                                                    src="/storage/{{ $result->company->logo }}" 
